      ...
      <FlexRow>
        <FlexCol columnSize={8} offset={2}>
          <Paragraph textAlign="center" mb="0.5em">
            ...
            provide basic building blocks with sensible defaults plus some bonus
            utility functions without getting in the way of what you want to build.
          </Paragraph>
        </FlexCol>
      </FlexRow>
    </>
